...
class OnnxStableDiffusionXLPipeline(DiffusionPipeline, FromSingleFileMixin):
    r"""
    ...
    def __init__(
        ...
        tokenizer: OnnxRuntimeModel,
        tokenizer_2: OnnxRuntimeModel,
        unet: OnnxRuntimeModel,
        scheduler: OnnxRuntimeModel,
        ...
        if prompt_embeds is None:
            ...
            for tokenizer, text_encoder in zip(tokenizers, text_encoders):
                ...
                if untruncated_ids.shape[-1] >= text_input_ids.shape[-1] and not torch.equal(
                    ...
                    max_length_minus_one = tokenizer.model_max_length - 1
                    removed_text = tokenizer.batch_decode(untruncated_ids[:, max_length_minus_one:-1])
                    logger.warning(
    ...
    def check_inputs(
        ...
        if negative_prompt_embeds is not None and negative_pooled_prompt_embeds is None:
            raise ValueError(
                ...
                + "Make sure to generate `negative_pooled_prompt_embeds` from the same text encoder that was used to "
